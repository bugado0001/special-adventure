...
import { PaperProvider, Text } from 'react-native-paper'; // Importe Text do react-native-paper
  ...
  return (
    <PaperProvider>
      <View style={styles.container}>
        ...
        <Text variant="displaySmall">Times</Text>
        <FlatList
          data={times}
          renderItem={({ item }) => (
            <Time
          ...
          keyExtractor={(item) => item.nome} // Adicione keyExtractor para evitar warnings
        />
      </View>
    </PaperProvider>
  );
